...
{\Large \bf Reply to Referee 2} 
	...
	%Some of these criticisms seem to reflect a rather hasty reading of the manuscript, as
	...
	6. Complaint about keywords absent from the abstract
		...
		%Given the Referee's confusion regarding our analyses, we are more convinced than ever that our decision to omit some keywords in favour of spending more words explaining our methodology was correct.
	...
	7. The focus of the introduction
		...
		% It is beyond the scope of this manuscript to test all possible reasons why closely-related plants might not share interaction partners.
	...
	13. Request to include plant species as a fixed effect
		...
		%DBS: I think your interpretation is incorrect here. I believe that they are referring to the fact that species with many interactions have a greater chance of "strong" overlap than species with few interactions. Either way though, I don't think this can be operationalized because each pairwise overlap value is tied to two species and not one (and that isn't tractable, in a way that I can think of...).
	...
	14. Request to include connectance
		...
		% DBS: This probably isn't true. If connectance were 0 there would be no overlap and if it were 1 overlap would be perfect. They probably think it sets a useful baseline. (?)
	...
	16. Critique of manuscript structure 
		...
		%We thank the Referee for the advice but can take little practical action without more details as to the nature of their objection.
	...
	18. Definition of community composition unclear
	    ...
	    %DBS: To be fair, I think this might still lack detail. When we say "differences in the composition" in the last sentence, should be say "beta-diversity metric X comparing the family-wise composition of the two networks?"
	...
	24. Suggestion to include ideas about evolution and coevolution 
		...
		\textbf{R:} %We do include ideas about evolution and coevolution in our discussion.
		...
		% DBS: Aren't you just beating a dead horse below with all the examples? Couldn't a list of the line numbers be sufficient? If I were this reviewer, this would piss me off. Though you might not like them, I seriously doubt that is the image or result you wish to project...
	...
	25. Objection to the word "broad"
		...
		% DBS: Again, do you really want to pick a fight that is a matter of splitting hairs? Why die in a ditch over our use of the term broad?
		...
		%and note that the Hembry et al reference suggested by the Referee uses the word in a very similar way.
		...
		% DBS: If you want to go down this line of argument, I would just leave it as broad....
