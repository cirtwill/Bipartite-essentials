...
\section*{Supporting information 3: Details of within-family regressions}
    ...
    Only nine families were sufficiently well-represented to fit models for shared herbivores. Five (\emph{Asteraceae}, \emph{Fabaceae}, \emph{Melastomataceae}, \emph{Poaceae}, and \emph{Rubiaceae}) were also well-represented in pollination networks. \emph{Euphorbiaceae}, \emph{Moraceae}, \emph{Nothofagaceae}, and \emph{Pinaceae} were only sufficiently represented in herbivory networks.
