...
%DIF DEL /Users/alyssacirtwill/Downloads/reply_to_referees_2_dbs.tex   Wed Dec 11 11:07:30 2019
%DIF ADD reply_to_referees_2.tex                                       Wed Dec 11 11:08:42 2019
...
\DIFdelend \DIFaddbegin \DIFadd{novelty }\DIFaddend of our study but have added the greater detail requested. In the spirit of not making the summary overly methodological, and because of the extremely tight word limit, we have not attempted to explain the unbalanced numbers of pollination and herbivory networks here. \DIFdelbegin \DIFdel{As before, this }\DIFdelend \DIFaddbegin \DIFadd{This }\DIFaddend information is contained in the Methods. 
	...
	12. Request to include plant species as a fixed effect
		...
		% DBS seems to think it's a generalist/specialist question, but I don't see that reading at all. Anyway, we do give more weight to information coming from generalists, but that's a feature not a bug.
	...
	%DIF < DBS: I'm cool with this response. I think it addresses the Referee's point quite clearly.
...
\DIFdelend 13. Request to include connectance
		...
		%DIF <  Seems like DBS thought he [sic] actually had a point here, so I guess I can't get away without doing more analysis.
		%DIF <  Nyuk, nyuk, nyuk.
%DIF >  Seems like DBS thought he actually had a point here, so I guess I can't get away without doing more analysis. 
