...
%DIF ADD reply_to_referees_njb_edits.tex   Sun Dec  8 09:51:18 2019
...
\DIFdelbegin \DIFdel{We are pleased to submit a revised version of our manuscript, NPH-MS-2019-30803. In response to a suggestion from Referee 3, we have re-titled it "". We have also taken care to revise our methods section in response to the many helpful suggestions from Referee 4, and hope that our approach is now clearer. Finally, we have expanded the discussion to include some additional concepts suggested by Referees 2 and 4, and a possible application of our research suggested by Referee 3. 
}%DIFDELCMD < 

%DIFDELCMD < 	%%%
\DIFdelend Given the difference of opinion between Referees 1, 3, and 4 and Referee 2, we have prioritised adjusting the manuscript according to the majority view. \DIFdelbegin \DIFdel{We must also admit to having some difficulty parsing a number of Referee 2's comments in order to find what is being asked. This may be partly because this review came from several people - the Referee refers to themselves as 'we' several times, and the writing appears to be more than usually variable within their comments. These difficulties mean that we may not have followed as many of Referee 2's suggestions as we have for the other Referees. }\DIFdelend Nevertheless, we \DIFdelbegin \DIFdel{do appreciate their time and effort in offering such extensive feedback and }\DIFdelend have taken care to address each of Referee 2's comments \DIFdelbegin \DIFdel{in the hope of at least clarifying our perspective.
}%DIFDELCMD < 

%DIFDELCMD < 	%%%
\DIFdel{We appreciate all of the Referees' comments andare confident that our manuscript is all the stronger for responding to them }\DIFdelend \DIFaddbegin \DIFadd{and, where possible, have used them to improve the manuscript}\DIFaddend .
...
%DIF <  NPH-MS-2019-30803 At a global scale, conservation of pollinators and herbivores between related plants varies widely across communities and between plant families.
%DIF <  by Cirtwill, Alyssa; Dalla Riva, Giulio; Baker, Nick; Ohlsson, Mikael; Norström, Isabelle; Wohlfarth, Inger-Marie; Thia, Josh; Stouffer, Daniel
\DIFaddbegin \DIFadd{NPH-MS-2019-30803 At a global scale, conservation of pollinators and herbivores between related plants varies widely across communities and between plant families.
...
%DIF <  Dear Dr Cirtwill
\DIFaddbegin \DIFadd{Dear Dr Cirtwill
}\DIFaddend 

%DIF <  I write you in regard to your submitted manuscript, NPH-MS-2019-30803 "At a global scale, conservation of pollinators and herbivores between related plants varies widely across communities and between plant families.”, which has now been reviewed. We found four reviewers (some original reviewers and some new) and they all generally enjoyed your revised manuscript. However, they also provided suggestions for some expanding certain sections and providing additional clarification. In particular, Reviewer \#2 and \#4 provide some detailed suggestions, especially with regard to keeping the aims and logic consistent, that will help strengthen the manuscript.
\DIFaddbegin \DIFadd{I write you in regard to your submitted manuscript, NPH-MS-2019-30803 "At a global scale, conservation of pollinators and herbivores between related plants varies widely across communities and between plant families.”, which has now been reviewed. We found four reviewers (some original reviewers and some new) and they all generally enjoyed your revised manuscript. However, they also provided suggestions for some expanding certain sections and providing additional clarification. In particular, Reviewer \#2 and \#4 provide some detailed suggestions, especially with regard to keeping the aims and logic consistent, that will help strengthen the manuscript.
}\DIFaddend 

%DIF <  Although resolving these issues will require some restructuring, I think you should be able to handle these suggestions through revision (see below) and, ultimately, this manuscript will make a nice contribution to the literature.
\DIFaddbegin \DIFadd{Although resolving these issues will require some restructuring, I think you should be able to handle these suggestions through revision (see below) and, ultimately, this manuscript will make a nice contribution to the literature.
}\DIFaddend 

%DIF <  Please carefully revise your manuscript and resubmit your revised version within 4 weeks. Please also include a summary of how you have incorporated the suggestions of the reviewers.
\DIFaddbegin \DIFadd{Please carefully revise your manuscript and resubmit your revised version within 4 weeks. Please also include a summary of how you have incorporated the suggestions of the reviewers.
}\DIFaddend 

%DIF <  Thank you for submitting your work to New Phytologist.
\DIFaddbegin \DIFadd{Thank you for submitting your work to New Phytologist.
}\DIFaddend 

%DIF <  Sincerely,
\DIFaddbegin \DIFadd{Sincerely,
}\DIFaddend 

%DIF <  Jana Vamosi
\DIFaddbegin \DIFadd{Jana Vamosi
}\DIFaddend 

%DIF <  Editor, New Phytologist
\DIFaddbegin \DIFadd{Editor, New Phytologist
}\DIFaddend 


%DIF <  Decision: Accept subject to revision
\DIFaddbegin \DIFadd{Decision: Accept subject to revision
}\DIFaddend 

\clearpage

{\Large \bf Reply to Referee 1} \DIFaddbegin [[\DIFadd{done}]]
\DIFaddend 
...
\DIFdelend 
	...
	The Referee \DIFdelbegin \DIFdel{(s?) }\DIFdelend seems to view our basic question and analyses positively, but is \DIFdelbegin \DIFdel{rather bluntly }\DIFdelend critical of our writing in terms of \DIFdelbegin \DIFdel{logical}\DIFdelend \DIFaddbegin \DIFadd{logic}\DIFaddend , clarity, and style. \DIFdelbegin \DIFdel{Some }\DIFdelend \DIFaddbegin \DIFadd{We were confused by some }\DIFaddend of these criticisms \DIFdelbegin \DIFdel{seem to reflect a rather hasty reading of the manuscript, }\DIFdelend as there are points where the Referee asks \DIFdelbegin \DIFdel{for analyses or ideas to be included which already appear }\DIFdelend \DIFaddbegin \DIFadd{why we did not conduct analyses that we did in fact perform or asks that we address biological complications that already appear later }\DIFaddend in the text. In these cases, we point to existing evidence in the manuscript and have tried to make these connections more obvious. \DIFdelbegin \DIFdel{In a few cases, we struggled to understand the nature of the Referee's objections. We have attempted to address each of }\DIFdelend \DIFaddbegin \DIFadd{We address }\DIFaddend the Referee's \DIFaddbegin \DIFadd{other }\DIFaddend comments in detail below (preceded by \textbf{R:}). \DIFdelbegin \DIFdel{Wherever possible, we have clarified our text in response to the Referee's comments. In particular, we now define community composition more explicitly, have revised the discussion to be more explicit about whether we are referring to overall or within-network trends, and have removed specific phrases that the Referee finds objectionable }\emph{\DIFdel{prima facie}}%DIFAUXCMD
\DIFdel{. }\DIFdelend We hope that \DIFdelbegin \DIFdel{these changes and our }\DIFdelend \DIFaddbegin \DIFadd{this }\DIFaddend response will clarify the focus and scope of our analyses.
	...
	1. General criticism of the language of the text
		...
		\textbf{R:} \DIFdelbegin \DIFdel{As Referees 1 and 3 note, our English is scrupulously correct. Of course technical correctness does not necessarily imply clarity of expression, and we apologise if our }\DIFdelend \DIFaddbegin \DIFadd{We acknowledge that our }\DIFaddend choice of vocabulary \DIFdelbegin \DIFdel{has }\DIFdelend \DIFaddbegin \DIFadd{or phrasing may have }\DIFaddend obfuscated some of the \DIFdelbegin \DIFdel{nuances }\DIFdelend \DIFaddbegin \DIFadd{finer points }\DIFaddend of the manuscript. \DIFdelbegin \DIFdel{We }\DIFdelend \DIFaddbegin \DIFadd{As such, we }\DIFaddend have endeavoured to clarify the manuscript as the Referee suggests.
...
%DIFDELCMD < 		%%%
\DIFdelend \DIFaddbegin \DIFadd{Title
		}\DIFaddend Your title still lacks clarity and does not reflect the main message you state at the beginning of your discussion (in the first sentence of it you state that you found broad support for the hypothesis that more closely related plants tend to have more niche overlap). We feel that this reflects lack of logical consistency across your manuscript, so re-thinking it should help to define your title.
		\end{refquote}

		\textbf{R:} We have revised the title following a more detailed suggestion by Referee 3 and \DIFdelbegin \DIFdel{hope }\DIFdelend \DIFaddbegin \DIFadd{believe }\DIFaddend that the new title \DIFdelbegin \DIFdel{no longer implies logical inconsistency}\DIFdelend \DIFaddbegin \DIFadd{provides additional logical consistency}\DIFaddend .
...
\DIFdelend \DIFaddbegin \DIFadd{General comments
	...
	4. \DIFdelbegin \DIFdel{Mis-understanding }\DIFdelend \DIFaddbegin \DIFadd{Persistent mis-understanding }\DIFaddend of purpose and scope of within-family analyses
...
\DIFdelend As we are \emph{not} searching for differences between communities at the family level, but rather at all levels within the angiosperms, a number of the Referee's comments do not apply. \DIFdelbegin \DIFdel{We list these below. 
	...
	5. Very confusing comment \DIFdelbegin \DIFdel{complaining about summary point }\DIFdelend \DIFaddbegin \DIFadd{referencing paragraph }\DIFaddend 4

		\begin{refquote}
		\DIFdelbegin \DIFdel{4st }\DIFdelend \DIFaddbegin \DIFadd{4th }\DIFaddend paragraph "Considering factors affecting the dominant plant families within
		...
		\textbf{R:} \DIFdelbegin \DIFdel{Apart from the Referee 's objection to plant families as units for detailed analysis (see respons \#4), this comment seems to demonstrate uncertainty about how we defined the dominant plant families in a community. Note that we do not mean to imply any functional argument here, as our manuscript does not address functionality. Rather, by '}\DIFdelend \DIFaddbegin \DIFadd{The Referee appears to object to any reference to plant families, but has not made the reasons for this objection clear. As noted above, we do in fact consider relationships between phylogenetic distance and interaction partner overlap at }\emph{\DIFadd{all}} \DIFadd{taxonomic levels, not just within families. Apart from this, we are confused by the remainder of the Referee's comment. By '}\DIFaddend dominant', we mean 'most species-rich in the focal community' \DIFdelbegin \DIFdel{. }\DIFdelend \DIFaddbegin \DIFadd{rather than any kind of functional interpretation. Note that we do not address functions in the rest of the manuscript, so it is not clear why the Referee makes this leap. }\DIFaddend In order to avoid future confusion, we now replace 'dominant families' with 'species-rich groups'. We hope that this makes it clear that we are advocating \DIFdelbegin \DIFdel{researcher take }\DIFdelend \DIFaddbegin \DIFadd{research that takes }\DIFaddend a finer-scale perspective on phylogenetic signal in ecological networks.
...
\DIFdelend General. You focus on the compromise between pollination and herbivory interactions but then you do not use this approach in your analyses.
	...
	8. Disagreement with any link between syndromes and conservation of interaction partners
		...
		\textbf{R:} As the Referee notes, we do address the possibility of convergence \DIFaddbegin \DIFadd{later }\DIFaddend in our introduction. We do not make any claim as to whether the putative pollination syndromes actually reflect plants with common sets of pollinators (the evidence we are aware of is rather mixed). Since the Referee appears to object to this \DIFdelbegin \DIFdel{idea (which we note is quite common }\DIFdelend \DIFaddbegin \DIFadd{very common idea }\DIFaddend in the literature\DIFdelbegin \DIFdel{surrounding phylogenetic conservation of interactions)}\DIFdelend , and because syndromes do not form a major part of our analysis, we have removed it as a keyword and rephrased our introduction\DIFdelbegin \DIFdel{so that it now }\DIFdelend \DIFaddbegin \DIFadd{. Our manuscript }\DIFaddend no longer references pollination syndromes. Hopefully this will \DIFdelbegin \DIFdel{help readers to take our manuscript on its own merits rather than those of the syndrome concept}\DIFdelend \DIFaddbegin \DIFadd{avoid other readers becoming distracted by the idea of syndromes}\DIFaddend .


		Lines \DIFdelbegin \DIFdel{11-14}\DIFdelend \DIFaddbegin \DIFadd{XX-XX}\DIFaddend :
	...
	9. Request to include interaction intimacy \DIFaddbegin [[\DIFadd{done}]]
\DIFaddend 
		...
		\textbf{R:} We have no information on interaction strengths or intimacies, and \DIFdelbegin \DIFdel{we note that the interactions we consider are generally low-intimacy. We therefore would not expect intimacy to strongly affect these networks. }\DIFdelend \DIFaddbegin \DIFadd{so cannot test whether this is affecting our results. }\DIFaddend However, we are happy to include the idea as yet another reason why plant communities may or may not show conservation of interactions. We have added a brief description of intimacy as follows:


		Lines \DIFdelbegin \DIFdel{29-37}\DIFdelend \DIFaddbegin \DIFadd{XX-XX}\DIFaddend :

		\begin{quotation}

			In mutualistic networks, animals often show a stronger phylogenetic signal in their partners than do plants~\citep{Rezende2007a,Chamberlain2014,Rohr2014,Vamosi2014,Lind2015,Fontaine2015} (but see~\citet{Rafferty2013} for a counterexample). In antagonistic networks, however, actively-foraging consumers tend to show less phylogenetic signal than their prey~\citep{Ives2006,Cagnolo2011,Naisbit2011,Fontaine2015}. In part, this may be related to different degrees of interaction intimacy (dependence of one \DIFdelbegin \DIFdel{partner }\DIFdelend \DIFaddbegin \DIFadd{predator }\DIFaddend on another), which appears to contribute to network structure in mutualistic, but not antagonistic, networks~\citep{Guimaraes2007,Ponisio2017}. 

		\end{quotation}


	\DIFdelbegin \DIFdel{In addition to the above, we have added another brief discussion of intimacy in the discussion (see response \#28)
}%DIFDELCMD < 

%DIFDELCMD < 	%%%
\DIFdelend 10. \DIFdelbegin \DIFdel{Criticism of dataset }\DIFdelend \DIFaddbegin \DIFadd{Criticisism of methodological }\DIFaddend changes required by previous reviewers
...
\DIFdelend \DIFaddbegin \DIFadd{Dataset
			}\DIFaddend Several networks can be reviewed in the literature or are available in different websites. Why authors decide not to consider several plant-herbivore networks but have no filter to separate plant-pollinator networks? The reason of why focusing in plant-pollinator and plant-herbivory networks is not clear for us as well why authors choose to select just one kind of herbivory interaction and as a consequence have a highly unbalanced design. Such decision seems to be crucial as it may modulate the results and conclusions they achieve. By eliminating the herbivory interactions that are more phylogenetically constrained their result that pollination interactions may be more conserved than herbivory interactions seems to be a by-product of such decision.
		\end{refquote}


		\textbf{R:} We \DIFdelbegin \DIFdel{included all herbivory networks we could find when we began this project, and only }\DIFdelend restricted our selection of herbivory networks in response to a previous round of review. Without more details \DIFaddbegin \DIFadd{on }\DIFaddend why (or if) the Referee believes that the herbivory networks we removed should be included, we have opted to continue following that earlier feedback. We would have appreciated specific \DIFdelbegin \DIFdel{tips }\DIFdelend \DIFaddbegin \DIFadd{examples }\DIFaddend for additional herbivory networks, but since the Referee does not provide any specifics \DIFdelbegin \DIFdel{we do not feel that conducting an extensive search for additional networks and repeating our analyses is viable within the timeframe given to respond to this review}\DIFdelend \DIFaddbegin \DIFadd{there is little we can do to address this comment}\DIFaddend .


	11. Request to change "insects consuming leaves" to "chewing insects" \DIFaddbegin [[\DIFadd{done}]]
\DIFaddend 
	...
	12. Recommendation to continue using \DIFdelbegin \DIFdel{Jaccard dissimilarity, binomial regression
}\DIFdelend \DIFaddbegin \DIFadd{the same methodology
}\DIFaddend 
		...
		\begin{refquote}
			...
			\DIFdelbegin %DIFDELCMD < \\
%DIFDELCMD < 			%%%
\DIFdelend Why you used absolute numbers to measure shared and unshared pollinators and not the Jaccard index? Or, instead, why you did not use a binomial regression considering the absolute number of the whole set of pollinators that can be shared ? You should use generalized linear models with a binomial distribution considering the total number of pollinators and shared pollinators to give more weight to those species sharing more pollinators in a larger sample (generalists s for instance). It is not clear for us if your analysis considers the full number of species over which you obtain the percentage of shared species.
		\end{refquote}

		\textbf{R:} We did use a Jaccard index, as stated in the first \DIFdelbegin \DIFdel{sentence }\DIFdelend \DIFaddbegin \DIFadd{and second sentences }\DIFaddend under the sub-heading \textbf{Calculating niche overlap between communities}\DIFdelbegin \DIFdel{in the previous revision. This line read as follows (emphasis added): 
		}%DIFDELCMD < \begin{quotation}
%DIFDELCMD < 		%%%
\DIFdel{We calculated niche overlap for each pair of species within a community }\emph{\DIFdel{using a Jaccard index}} %DIFAUXCMD
\DIFdel{to describe the number of shared interaction partners, augmented with the number of interaction partners which were not shared.
		}%DIFDELCMD < \end{quotation}
%DIFDELCMD < 

%DIFDELCMD < 		%%%
\DIFdelend \DIFaddbegin \DIFadd{. }\DIFaddend The Jaccard index is calculated using the number of shared and un-shared interaction partners for a pair of plants, as stated in equation 1. We also did use a generalised linear model with binomial error distribution, as stated in the \textbf{Statistical analysis} section. We chose this methodology for exactly the reasons the Referee suggests, to give more weight to generalists sharing many interaction partners. This is stated in lines \DIFdelbegin \DIFdel{138-141 and lines 148-154 }\DIFdelend \DIFaddbegin \DIFadd{XX-XX }\DIFaddend (quoted below). \DIFdelbegin \DIFdel{Note that we have revised these lines somewhat in response to a suggestion from Referee 4, so they do differ somewhat from the previous version. }\DIFdelend We are glad that the Referee agrees with our choice in \DIFdelbegin \DIFdel{methodology}\DIFdelend \DIFaddbegin \DIFadd{methdology}\DIFaddend .

		\begin{quotation}

			\DIFdelbegin \DIFdel{Together, $M_{ij}$ and $U_{ij}$ give a Jaccard index ($J_{ij}$) describing 
			the proportion of shared interactions. $J_{ij}$ is defined: 
}%DIFDELCMD < 

%DIFDELCMD < 			%%%
\begin{displaymath}
			\DIFdel{J_{ij} = \frac{M_{ij}}{U_{ij}+M_{ij}} ,
			}\end{displaymath}
			%DIFAUXCMD
%DIF < 
			\DIFdel{where $M_{ij}$ is the set of }\emph{\DIFdel{mutual}} %DIFAUXCMD
\DIFdel{(shared) interaction partners and $U_{ij}$ the set of unshared interaction partners for plants $i$ and $j$}\DIFdelend \DIFaddbegin \DIFadd{We wished to give more 
		    ...
		    interaction partner)}\DIFaddend . \DIFdelbegin %DIFDELCMD < 
...
%DIFDELCMD < 			%%%
\DIFdel{We modelled the relationship between niche overlap and phylogenetic 
			...
			centred, scaled phylogenetic distance as 
		    the independent variable. This 
			approach is conceptually similar to modelling successes and failures in a binomial-distributed process.Accordingly, we assumed a binomially-distributed error structure and used a logit link function to model the dissimilarity in interaction partners $J_{ij}$ of plants $i$ and $j$}\DIFdelend \DIFaddbegin \DIFadd{Note that species sharing a large }\emph{\DIFadd{number}} \DIFadd{of interaction partners may not share a large }\emph{\DIFadd{proportion}} \DIFadd{of interaction partners if the number of interaction partners that are not shared is also large}\DIFaddend .

		\end{quotation}


	\DIFdelbegin \DIFdel{As stated in the section on phylogenetic data, we excluded comparisons involving plants for which we could not assign a binomial names (and therefore could not obtain phylogenetic distances)and comparisons between non-angiosperms due to our coarse estimates of their ages. This information appeared in lines 107-110 and 118-120 of the previous version and lines 112-115 and 122-124 of the current version.
}%DIFDELCMD < 

%DIFDELCMD < 	%%%
\DIFdelend 13. Request to include plant species as a fixed effect \DIFaddbegin [[\DIFadd{done}]]
\DIFaddend 
		...
		\textbf{R:} It sounds as though the Referee would like us to include plant species as a predictor in our regressions. Due to the fact that \DIFaddbegin \DIFadd{individual }\DIFaddend species generally appear in few networks (many in only a single network), this would result in near singularity of our models. We would therefore be completely unable to observe any patterns as species identity would explain \DIFdelbegin \DIFdel{nearly all variationin niche overlap}\DIFdelend \DIFaddbegin \DIFadd{essentially all variation}\DIFaddend . If the Referee is referring to a potential effect of network size, we did in fact test this (see equation 4 and description).
\DIFdelbegin \DIFdel{If the Referee did not mean either of these possibilities, we apologise but are unable to understand this comment.
}\DIFdelend 


	\DIFdelbegin \DIFdel{14. Request }\DIFdelend \DIFaddbegin \DIFadd{16. Un-justified request }\DIFaddend to include connectance
		...
		\textbf{R:} \DIFdelbegin \DIFdel{Our main reason for including network size as a potential effect was methodological rather than biological - slopes for smaller networks are based on smaller sample sizes and therefore may be less robust. We do not see either the methodological or biological arguments for including connectance as a predictor. We also note that the manuscript is already quite full, so including these new analyses would require us to remove something more important. Without a justification from the Referee as to }\DIFdelend \DIFaddbegin \DIFadd{We did not include connectance because we can offer no justification (biological or methodological) why the overall connectance of the network should affect the strength of the relationship between relatedness and niche overlap. It is possible that there might be an effect of connectance on the intercept of this relationship (as we would expect higher overlap in general when connectance is high), but we see no particular reason }\DIFaddend why connectance should \DIFdelbegin \DIFdel{affect pairwise niche overlap}\DIFdelend \DIFaddbegin \DIFadd{change how closely-related species differ from distantly-related species in the same network. Since the Referee also does not provide any reasoning behind this request}\DIFaddend , we have opted \DIFdelbegin \DIFdel{not to add this new thread to the manuscript}\DIFdelend \DIFaddbegin \DIFadd{to leave our analyses as-is}\DIFaddend .


		\DIFdelbegin \DIFdel{15. }\DIFdelend \DIFaddbegin [[\DIFadd{Maybe I can add a bit of a biological argument that network size can affect overlap? I'm not sure what methodological but not biological means here.}]]

		\textbf{\DIFadd{Nick:}} \DIFadd{I'm super confused by this comment as well. R2 seems to want more information about connectance but then complains about the lack of biological arguments for network size and niche overlap. I think if you have something you can mention about the biological argument you can mention it but anything you add here addressing this comment we may need to add to the manuscript unless you can phrase it in a way that indicates its somewhat ridiculous to mention and wouldn't contribute to the paper but still explains why we left it out. I was also trying to wrack my brain about connectance affecting the strength of the relationship between relatedness and niche overlap... I feel like if we start going into detail about connectance and how that plays you would have a stronger argument talking about modularity / nestedness instead because at least those two measurements indicate differences in interactions; but that is way outside the scope of this paper.
}
...
\DIFdelbegin \DIFdel{Note that we cannot use Shannon diversity within networks as we do not know the abundances of the various plant species. All we can do is test the effect of numbers of species as described above.
	...
	\DIFdelbegin \DIFdel{16. }\DIFdelend \DIFaddbegin \DIFadd{18. }\DIFaddend Critique of manuscript structure 

		\begin{refquote}
			Results
			\DIFdelbegin %DIFDELCMD < \\
%DIFDELCMD < 			%%%
\DIFdelend General: Please, do not include discussion in your results, it may confound readers.
		\end{refquote}

		\textbf{R:} \DIFdelbegin \DIFdel{We are unsure whether the Referee is giving general advice here or if there is a specific element of the results the Referee feels would fit better in the discussion . We thank the Referee for the advice but can take little practical action without more details as to the nature of their objection}\DIFdelend \DIFaddbegin \DIFadd{Without knowing where, specifically, the Referee feels that we have included discussion in our results there is little we can do to address this complaint}\DIFaddend .


	\DIFdelbegin \DIFdel{17. }\DIFdelend \DIFaddbegin \DIFadd{19. }\DIFaddend Incorrect claim that beginning of results is inaccurate
		...
		\textbf{R:} \DIFdelbegin \DIFdel{This comment's somewhat eccentric grammar makes it rather difficult to parse. We are guessing that }\DIFdelend \DIFaddbegin \DIFadd{It is not clear whether }\DIFaddend the Referee is \DIFdelbegin \DIFdel{confused by the overall trend (more related plants have more similar interaction partners) and the variability of the trends within specific networks . To help understand this, note that the structure of the first few lines of the discussion parallel the first few lines of the results. First we introduce the overall result, and then we expand upon the details.
We have lightly edited lines 370-373 to make this clearer: }\DIFdelend \DIFaddbegin \DIFadd{suggesting that we repeat our analyses using half of the pollination networks (without any clear reason as to why) or is simply confused about which analysis these results refer to. Since the Referee appears to have assumed that the within-family analyses are the }\emph{\DIFadd{only}} \DIFadd{analyses in the manuscript, the latter seems likely.
}\DIFaddend 
...
%DIFDELCMD < 			%%%
\DIFdel{We found general support for the hypothesis that more
			...
			interaction partners decreased }\DIFdelend \DIFaddbegin \DIFadd{Note that the results in lines XX-XX correspond to our first analysis: testing whether niche overlap decreases over increasing phylogenetic
		distance in a large dataset of pollination and herbivory networks. The overall regression did show that partner overlap decreases }\DIFaddend with increasing phylogenetic distance\DIFdelbegin \DIFdel{. Considering networks separately . ..
}\DIFdelend \DIFaddbegin \DIFadd{, so that more distantly-related plants are less likely to share interaction partners (see Fig. 1). The rest of this section gives more details about the differences between pollination and herbivory networks (lines XX-XX) and variation across networks (lines XX-XX), but note that none of these details change the overall regression. As this text is correct we have left it unchanged.
}\DIFaddend 


	\DIFdelbegin %DIFDELCMD < \end{quotation}
%DIFDELCMD < 

%DIFDELCMD < 	%%%
\DIFdel{18. }\DIFdelend \DIFaddbegin \DIFadd{20. }\DIFaddend Definition of community composition unclear
		...
		\begin{quotation}
		    ...
		    \DIFaddbegin \DIFadd{pairwise }\DIFaddend niche overlap are due to the different distributions 
		    ...
		    to differences in the composition of the plant community \DIFaddbegin \DIFadd{(defined as the number of species in each plant family present in each network) }\DIFaddend using a non-parametric permutational multi-variate 
		    analysis of variance (PERMANOVA;~\citealp{Anderson2001}).
	    \end{quotation}


	\DIFdelbegin \DIFdel{19. }\DIFdelend \DIFaddbegin \DIFadd{21. }\DIFaddend Confusion about permutation methodology
		...
		\textbf{R:} As stated in the methods, we permuted interactions. Note that, in statistical terms, the two approaches are equivalent\DIFdelbegin \DIFdel{, but we appreciate that this may not be clear to readers unfamiliar with permutation approaches}\DIFdelend . We have rephrased the results to match the methods.


	\DIFdelbegin \DIFdel{20. }\DIFdelend \DIFaddbegin \DIFadd{22. }\DIFaddend Typo in Fig. 1 caption
	...
	\DIFdelbegin \DIFdel{21. }\DIFdelend \DIFaddbegin \DIFadd{23. }\DIFaddend Difference between minimum and maximum slopes not visible
	...
	\DIFdelbegin \DIFdel{22. }\DIFdelend \DIFaddbegin \DIFadd{24. }\DIFaddend Confusion about line 328

		\begin{refquote}
			Line  328: "...increasing phylogenetic distance in 12...", what is 12? the number of families?
		\end{refquote}

		\textbf{R:} \DIFdelbegin \DIFdel{Yes, }\DIFdelend \DIFaddbegin \DIFadd{The number }\DIFaddend 12 \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{referred to }\DIFaddend the number of families. We have revised \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{this }\DIFaddend line to make this more explicit.
\DIFdelbegin \DIFdel{Note that we have also corrected this line to match Table 1, which includes 14 significant families.
}\DIFdelend 


		Lines \DIFdelbegin \DIFdel{355-356}\DIFdelend \DIFaddbegin \DIFadd{XX-XX}\DIFaddend : 


		\begin{quotation}

		In pollination networks, overlap decreased significantly with increasing phylogenetic distance in \DIFdelbegin \DIFdel{14 }\DIFdelend \DIFaddbegin \DIFadd{12 }\DIFaddend of the 48 well-represented families
\DIFdelbegin \DIFdel{(Table 1; Fig. 3).
}\DIFdelend 

		\end{quotation}


	\DIFdelbegin \DIFdel{23. }\DIFdelend \DIFaddbegin \DIFadd{25. }\DIFaddend Complaints about table numbering and figure referencing
	...
	\DIFdelbegin \DIFdel{24. Suggestion to include ideas about evolution and coevolution 
}\DIFdelend \DIFaddbegin \DIFadd{26. Request for more evolution content
}\DIFaddend 
		...
		\textbf{R:} We do include ideas about evolution and coevolution in our discussion. We \DIFdelbegin \DIFdel{completely }\DIFdelend agree that, together with ecological processes and environmental filtering, evolution and coevolution are very important in structuring networks\DIFdelbegin \DIFdel{at every level, from pairs of species to entire communities}\DIFdelend . However, since we do not have trait or genetic data for our networks, we cannot comment with any certainty on which of our results are due to trait plasticity or environmental influence and which are due to evolution. \DIFdelbegin \DIFdel{We therefore mention possible evolutionary and ecological explanations together. }\DIFdelend \DIFaddbegin \DIFadd{Specialists, for example, could have co-evolved with particular interaction partners. They could also, however, be able to interact with more species which simply do not appear in the study site due to competition, unsuitable soil conditions, etc. As Referee 4 notes, specialists may also simply be species which were sampled more rarely. That is, we may be missing interactions involving these species which actually do occur. Please note that the proportion of specialists is a potential explanation for the results we observed and not a key result in itself. As such, we feel that spending a great deal of time trying to explain this trend would distract readers from the main message of our paper.
}\DIFaddend 


		\DIFdelbegin \DIFdel{Some examples of evolutionary ideas in the discussion}\DIFdelend \DIFaddbegin \DIFadd{Note that the previous version did touch on evolutionary ideas. Some examples}\DIFaddend :

		\DIFdelbegin \DIFdel{Lines 413-418:
}%DIFDELCMD < 
...
\DIFdelend \begin{quotation}
			...
			such that closely related plants resemble their common ancestor--- and
			  ...
			  heritability of key traits may, however, differ between families. \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < 		\end{quotation}
%DIFDELCMD < 

%DIFDELCMD < 		%%%
\DIFdel{Lines 420-427:
}%DIFDELCMD < 
...
\DIFdelend \DIFaddbegin \DIFadd{In
			  some families, such as }\emph{\DIFadd{Asteraceae}} \DIFadd{in pollination networks, 
			  the positive slope of this relationship was very shallow while in 
			  others, such as }\emph{\DIFadd{Melastomataceae}} \DIFadd{in herbivory networks, the 
			  positive slope was extremely steep. }\DIFaddend This could indicate different 
			  rates of phenotypic drift or evolution in different families\DIFdelbegin \DIFdel{(or their interaction partners)}\DIFdelend . 
			  In other families, there was no significant relationship between phylogenetic
			  distance and \DIFdelbegin \DIFdel{niche }\DIFdelend \DIFaddbegin \DIFadd{interaction partner }\DIFaddend overlap. In these cases, key traits affecting 
			  plant-insect interactions may \DIFdelbegin \DIFdel{be highly labile or plastic (environmentally determined). These possibilities are supported by several studies }\DIFdelend \DIFaddbegin \DIFadd{not be strongly
			  conserved. Studies }\DIFaddend showing a stronger relationship between \DIFdelbegin \DIFdel{niche overlap and trait similarity
			  than niche overlap and phylogenetic }\DIFdelend \DIFaddbegin \DIFadd{trait }\DIFaddend similarity
			  \DIFdelbegin \DIFdel{~\mbox{%DIFAUXCMD
\citep{Junker2015,Ibanez2016,Endara2017}}\hspace{0pt}%DIFAUXCMD
. 
}%DIFDELCMD < 
...
%DIFDELCMD < 			%%%
\DIFdel{First, part of the family may have recently 
			...
			interaction partners ~\mbox{%DIFAUXCMD
\citep{Linder2008,Breitkopf2015}}\hspace{0pt}%DIFAUXCMD
. Likewise, the
			animals may have undergone an adaptive radiation to 
			specialise on their most profitable partner~\mbox{%DIFAUXCMD
\citep{Janz2006}}\hspace{0pt}%DIFAUXCMD
. 
...
%DIFDELCMD < 			%%%
\DIFdel{Selection to avoid 
			competition and restrict numbers of interaction partners may lead to
			more intimate or specialised interactions~\mbox{%DIFAUXCMD
\citep{Ponisio2017}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{and shared interaction partners than phylogenetic similarity and shared
			  interaction partners suggest that traits may indeed be evolutionarily
			  labile~\mbox{%DIFAUXCMD
\citep{Junker2015,Ibanez2016,Endara2017}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend . 
		...
		\DIFdelbegin \DIFdel{Lines 458-466:
}%DIFDELCMD < 

%DIFDELCMD < 		%%%
\DIFdelend \begin{quotation}

			\DIFdelbegin \DIFdel{These plants might 
			be highly specialised on different interaction partners and therefore
			have low overlap at all levels of relatedness. }\DIFdelend In other plant families
		...
		\DIFdelbegin \DIFdel{Lines 476-482:
}\DIFdelend \DIFaddbegin \DIFadd{See also lines XX-XX, where we discuss constraints on traits. We have lightly revised these lines to reference evolution explicitly. 
}\DIFaddend 

		\begin{quotation}

		 This \DIFdelbegin \DIFdel{could be because of conflicting selection from pollinators and herbivores,
			with }\DIFdelend \DIFaddbegin \DIFadd{may indicate that }\DIFaddend one type of \DIFdelbegin \DIFdel{selection placing greater constraints on plant traits }\DIFdelend \DIFaddbegin \DIFadd{interaction
		  places greater evolutionary constraints upon these families }\DIFaddend than the other\DIFdelbegin \DIFdel{.
...
\citep{Strauss1997,Strauss2002,Adler2004,Adler2006,Theis2006}}\hspace{0pt}%DIFAUXCMD
.
  		}\DIFaddend \end{quotation}


	\DIFdelbegin \DIFdel{25. }\DIFdelend \DIFaddbegin \DIFadd{27. }\DIFaddend Objection to the word "broad"
		...
		\DIFaddbegin \textbf{\DIFadd{Nick:}} \DIFadd{I think they are suggesting that our evidence was only in 55(6?)\% of our plant-pollinator networks and not in our other network types, thus ''almost half ''. However I agree that our results still show broad support.
}

		\DIFaddend \textbf{R:} \DIFdelbegin \DIFdel{Note }\DIFdelend \DIFaddbegin \DIFadd{We note }\DIFaddend that 56\% is greater than half \DIFaddbegin \DIFadd{of those networks}\DIFaddend , and that when all networks were considered together we also observed the same trends. We contend that these two facts do represent broad support for our hypothesis\DIFdelbegin \DIFdel{and note that the Hembry et al reference suggested by the Referee uses the word in a very similar way. Broad support }\DIFdelend \DIFaddbegin \DIFadd{. It }\DIFaddend is not, of course, universal support. That is why we \DIFaddbegin \DIFadd{A) did not claim universal support and B) }\DIFaddend provide the numbers of networks. Readers are thereby armed with the tools to agree or disagree with our choice of words. In \DIFdelbegin \DIFdel{case it is the synonymy between broad and general that has perplexed the Referee}\DIFdelend \DIFaddbegin \DIFadd{an effort to be as unbiased as possible while discussing our results}\DIFaddend , we have changed this line to state ''We found \emph{general} support...''. We hope that this is clearer.


		\DIFdelbegin \DIFdel{We are glad that the Referee finds the greater proportion of significant herbivory networks interesting. }\DIFdelend With the unbalanced sample sizes of pollination and herbivory networks, \DIFdelbegin \DIFdel{however, we are somewhat }\DIFdelend \DIFaddbegin \DIFadd{we are }\DIFaddend reluctant to make much of the difference between 56\% \DIFaddbegin \DIFadd{of pollination networks }\DIFaddend and 64\% \DIFaddbegin \DIFadd{of herbivory networks}\DIFaddend . We consider that the important point here is that networks are more likely than not to show decreasing niche overlap with increasing phylogenetic distance. 


	\DIFdelbegin \DIFdel{26. Confusing complaint }\DIFdelend \DIFaddbegin \DIFadd{28. Question }\DIFaddend about subsetting herbivory networks or perhaps objection to the claim that oligotrophy is common
		...
		\textbf{R:} We must again point out that subsetting the herbivory networks as we have done was requested during an earlier round of review. We are therefore reluctant to reconsider this approach without a very good reason. \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < 		%%%
\DIFdelend Beyond that, it is very difficult to work out exactly what the Referee objects to in this sentence. If the Referee is objecting to our references, note that~\citet{Novotny2005} addresses leaf-chewers as intermediate in their level of specialisation on particular families and emphasises that herbivores in general (regardless of guild) tend to consume a few closely-related hosts. They point out the relative rarity of strict specialists compared to specialists on species within a particular genus or family.~\citet{Brandle2006} also found insect herbivores were specialised on a particular genus but consumed multiple species within the genus. As~\citet{Brandle2006} focus on phytophagous insects specifically, we feel that this reference addresses our point more directly than~\citet{Yguel2011}. We have therefore replaced this reference.
\DIFdelbegin \DIFdel{We hope that this improved selection of references will help the Referee's confusion.
}\DIFdelend 


		If the Referee objects to our finding that the herbivores in our networks tended to consume more than one plant species, there is little we can do about it. That is simply what our data say. \DIFaddbegin \DIFadd{We do not feel that it is appropriate to look for explanations in the trends we observe in our networks in other types of networks. 
}\DIFaddend 


		If the Referee is contending that, because of the multiple herbivore types in~\citet{Novotny2005}, we cannot claim that the herbivores in our dataset are oligotrophs, we can respond with further details. The mean number of plants consumed per herbivore ranged between 1.64 and 14.9 across networks, with a mean of 6.36, and the median ranged \DIFdelbegin \DIFdel{between }\DIFdelend \DIFaddbegin \DIFadd{bewteen }\DIFaddend 1 and 11.5 (mean 4.68). These measures indicate that many herbivores in our networks do, in fact, consume only a few of the plants available to them\DIFdelbegin \DIFdel{(with some highly generalist species increasing the means).
Our overall point, that oligotrophy may be common in herbivores, therefore stands.
}\DIFdelend \DIFaddbegin \DIFadd{.
}\DIFaddend 


	\DIFdelbegin \DIFdel{27. }\DIFdelend \DIFaddbegin \DIFadd{29. }\DIFaddend Claims that congeneric species are not closely related
		...
		\textbf{\DIFdelbegin \DIFdel{R}\DIFdelend \DIFaddbegin \DIFadd{Nick}\DIFaddend :} \DIFdelbegin \DIFdel{Does the Referee really mean to suggest that }\DIFdelend \DIFaddbegin \DIFadd{This seems like a rather unclear argument from the reviewer. To state that congeneric species can not be closely related is basically arguing that being closely related taxonomically does not mean that those species are closely related phylogenetically. However, I agree that if they are going to make a statement that powerful, they should provide references and a very clear rationale to make the requested change. Can we find a reference where someone else talks about taxonomic and phylogenetic relationships as we have? Just as a justification tool more than anything?
}

		\textbf{\DIFadd{R:}} \DIFadd{We are confused by this comment, is the Referee suggesting that }\DIFaddend plants in the same genus are \DIFdelbegin \DIFdel{generally }\DIFdelend less closely-related than plants in different families? \DIFdelbegin \DIFdel{Without some sources to substantiate this, we find this claim very counter-intuitive. This is especially }\DIFdelend \DIFaddbegin \DIFadd{This comment is }\DIFaddend surprising given the Referee's insistence that we should expect similar interaction partners within a family. We agree that taxonomy is only a proxy for phylogeny, but we are not aware of any evidence that it is a poor proxy. We \DIFdelbegin \DIFdel{also note A) that similar language is quite common in the literature and B) that }\DIFdelend \DIFaddbegin \DIFadd{note that }\DIFaddend across seven other reviews, no other Referee has \DIFdelbegin \DIFdel{suggested that species in the same taxonomic groups (e. g., genera) are less closely-related than species in different groups. Without any evidence to support this claim}\DIFdelend \DIFaddbegin \DIFadd{commented on this. Based on this lack of objection and similar language throughout the literature}\DIFaddend , we have opted not to change \DIFdelbegin \DIFdel{our text}\DIFdelend \DIFaddbegin \DIFadd{this line}\DIFaddend .



	\DIFdelbegin \DIFdel{28. }\DIFdelend \DIFaddbegin \DIFadd{30. }\DIFaddend Another demand to discuss intimacy [[\DIFdelbegin \DIFdel{done. Look for more places to scattershot Hembry}\DIFdelend \DIFaddbegin \DIFadd{possibly addressable, since we did add a tiny reference in intro}\DIFaddend ]]
		...
		\textbf{R:} We do not \DIFdelbegin \DIFdel{believe that interaction intimacyhas a strong effect on our results, as both leaf-chewing herbivory and pollination are low-intimacy interactions~\mbox{%DIFAUXCMD
\citep{Astegiano2017}}\hspace{0pt}%DIFAUXCMD
. It is possible that there is variation in intimacy within these broad categories, but we do not have data that would allow us to test such a hypothesis. We also note that~\mbox{%DIFAUXCMD
\citet{Hembry2018} }\hspace{0pt}%DIFAUXCMD
study a very small and high-intimacy system (a single genus of brood pollinating moths and their single genus of host plants). Their results will therefore not necessarily generalize to the larger, more diverse networks we consider. Indeed, had they considered a broader sample of plants and seed predators or herbivores from the same islands, they easily could have found less reciprocal specialisation. As a detailed study of this unusual mutualism was the aim in~\mbox{%DIFAUXCMD
\citet{Hembry2018} }\hspace{0pt}%DIFAUXCMD
this is not a problem for their work, but we are hesitant to infer too strong a relationship between their findings and ours.
}%DIFDELCMD < 

%DIFDELCMD < 		%%%
\DIFdel{This reference suggestion is also somewhat confusing as~\mbox{%DIFAUXCMD
\citet{Hembry2018} }\hspace{0pt}%DIFAUXCMD
did not find evidence for host-associated differentiation in their moths. This would seem to undermine the idea that evolution/coevolution can explain network structure. Moreover, they point out that the support for the intimacy hypothesis  in their system was broad (in the same sense we used the word) but equivocal. This exacerbates the difficulty of extrapolating their work to explain }\DIFdelend \DIFaddbegin \DIFadd{have any data on interaction intimacy, so we cannot say how this would influence }\DIFaddend our results. \DIFaddbegin [[\DIFadd{I'll work on adding some kind of ref to this Hembry thing.}]]
\DIFaddend 


\DIFdelbegin \DIFdel{Given all of the above, it is hard to see how the interaction intimacy hypothesis relates to these lines (which are about whether the number of species in different plant families is related to the strength of phylogenetic signal). Instead, we feel that a discussion of the possible effects of intimacy is more relevant later on , where we discuss possible reasons why some families may show different trends. This section (lines 443-454) now reads:
}%DIFDELCMD < 
...
%DIFDELCMD < 			%%%
\DIFdel{Indeed, animal pollination and seed dispersal have been shown to act
			as filters for several plant clades~\mbox{%DIFAUXCMD
\citep{Mayfield2009}}\hspace{0pt}%DIFAUXCMD
. Selection to avoid 
			competition and restrict numbers of interaction partners may lead to more intimate or specialised interactions~\mbox{%DIFAUXCMD
\citep{Ponisio2017}}\hspace{0pt}%DIFAUXCMD
. 
			Reciprocal specialisation is particularly expected in highly intimate interactions~\mbox{%DIFAUXCMD
\citep{Hembry2018} }\hspace{0pt}%DIFAUXCMD
rather than the relatively low-intimacy pollination or leaf-chewing herbivory we consider here~\mbox{%DIFAUXCMD
\citep{Astegiano2017}}\hspace{0pt}%DIFAUXCMD
.
			Despite this , it is still possible that some plant families may tend to have more intimate interactions than others.This could result, for example, if a plant is pollinated by an insect which is also a herbivore in its larval stage~\mbox{%DIFAUXCMD
\citep{Hembry2018}}\hspace{0pt}%DIFAUXCMD
. 
...
{\Large \bf Reply to Referee 3} \DIFaddbegin [[\DIFadd{Still to do: title, add a bit about how this could be relevant for conservation.}]]
\DIFaddend 
...
\DIFdel{Altogether, our study has revealed general trends for conservation of interaction
		...
		community may be particularly important~\mbox{%DIFAUXCMD
\citep{Yguel2011,Castagneyrol2014}}\hspace{0pt}%DIFAUXCMD
.
...
\DIFaddend "\DIFaddbegin \DIFadd{At a global scale, conservation of pollinators and herbivores between related plants varies widely across communities and between plant families.”
}

\DIFadd{- suggests that we focus on broad support. Maybe "Broad conservation of pollinators and herbivores in a global dataset"?
"Despite variation among families, pollinators and herbivores are broadly conserved among related plants"?
"}\DIFaddend Related plants tend to share pollinators and herbivores, but strength of \DIFdelbegin \DIFdel{phylogenetic signal }\DIFdelend \DIFaddbegin \DIFadd{conservation }\DIFaddend varies among plant families"\DIFdelbegin \DIFdel{, strikes a balance between these two considerations.
}\DIFdelend \DIFaddbegin \DIFadd{?
}\DIFaddend 

	%DIF <  "At a global scale, conservation of pollinators and herbivores between related plants varies widely across communities and between plant families.”
\DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < 		%%%
%DIF <  - suggests that we focus on broad support. Maybe "Broad conservation of pollinators and herbivores in a global dataset"?
		%DIF <  "Despite variation among families, pollinators and herbivores are broadly conserved among related plants"?
		%DIF <  "Related plants tend to share pollinators and herbivores, but strength of phylogenetic signal varies among plant families"?
%DIFDELCMD < 

%DIFDELCMD < 	%%%
\DIFdelend 2. Request to state that networks are qualitative rather than quantitative \DIFaddbegin [[\DIFadd{done}]]
\DIFaddend 
		...
		Lines \DIFdelbegin \DIFdel{105-106 }\DIFdelend \DIFaddbegin \DIFadd{XX-XX }\DIFaddend (methods):

		\begin{quotation}

			All networks were qualitative\DIFdelbegin \DIFdel{and did not include interaction strengths}\DIFdelend \DIFaddbegin \DIFadd{, recording the presence or 
		    absence of interactions rather than their strength}\DIFaddend .

		\end{quotation}


		Lines \DIFdelbegin \DIFdel{294-296 }\DIFdelend \DIFaddbegin \DIFadd{XX-XX }\DIFaddend (results):
    	...
    	Lines \DIFdelbegin \DIFdel{504-505 }\DIFdelend \DIFaddbegin \DIFadd{XX-XX }\DIFaddend (discussion):
...
\DIFdelbegin \DIFdel{...
	...
	3. L298 – Please be careful with use of “lesser/greater” “more negative or positive than expected from permuted networks” \DIFaddbegin [[\DIFadd{done}]]
\DIFaddend 

		\textbf{R:} We appreciate that this \DIFdelbegin \DIFdel{description }\DIFdelend \DIFaddbegin \DIFadd{desceription }\DIFaddend could be unclear, and have revised this line as suggested. It now reads:

		Lines \DIFdelbegin \DIFdel{326-328}\DIFdelend \DIFaddbegin \DIFadd{XX-XX}\DIFaddend :
	...
	4. Typo in line 322 \DIFaddbegin [[\DIFadd{done}]]
		\DIFaddend 

		\begin{refquote}
			L322 – how was this result obtained if insect phylogenies were not \DIFdelbegin \DIFdel{calculated}\DIFdelend \DIFaddbegin \DIFadd{caclculated}\DIFaddend ? Do you mean “more closely-related plants in pollinator networks”?
		\end{refquote}
...
{\Large \bf Reply to Referee 4}
	...
	\textbf{R:} We thank the Referee for their compliments to our analysis and for taking the time to review our manuscript\DIFdelbegin \DIFdel{so thoroughly. We acknowledge }\DIFdelend \DIFaddbegin \DIFadd{. We appreciate }\DIFaddend that our writing can be dense at times and appreciate the Referee pointing out places where we may clarify our prose. \DIFdelbegin \DIFdel{We especially appreciate the detailed suggestions for how to improve our second-to-last paragraph, and have followed them to the best of our ability. }\DIFdelend Below, we respond to each comment in detail (preceded by \textbf{R:}). We are confident that revising the manuscript in response to the Referee's comments has \DIFdelbegin \DIFdel{significantly improved it}\DIFdelend \DIFaddbegin \DIFadd{improved the manuscript}\DIFaddend .


1. Confusion about description of \DIFdelbegin \DIFdel{tuple-form dependent variable
}\DIFdelend \DIFaddbegin \DIFadd{two dependent variables in analyses }[[\DIFadd{done}]]
\DIFaddend 
...
\DIFdelend I did not managed to fully grasp the statistical analysis right away (I reckon I'm not a statistical master, but this may be the case of other readers), and I think it was mostly due to the way the methods are described. The writing is nice, but some tiny details are missing while they could help the reader to understand more quickly how the authors distinguish the use of the {M\_ij, U\_ij}-tuple from that of J\_ij.
	...
	lines \DIFdelbegin \DIFdel{130-141}\DIFdelend \DIFaddbegin \DIFadd{XX-XX}\DIFaddend :


	\begin{quotation}

	    We calculated niche overlap for each pair of plants $i$ and $j$ based on the number of shared \DIFdelbegin \DIFdel{and unshared }\DIFdelend interaction
	    partners ($M_{ij}$\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{) and the number of interaction partners which are not
	    shared (}\DIFaddend $U_{ij}$\DIFdelbegin \DIFdel{, respectively}\DIFdelend ). The number of unshared interaction 
	    partners gives valuable information about cases where, for example, 
	    closely-related plants may have experienced disruptive selection, leading to weaker phylogenetic signal. The \DIFdelbegin \DIFdel{sum $M_{ij} + U_{ij}$ }\DIFdelend \DIFaddbegin \DIFadd{number of shared and unshared interaction partners together }\DIFaddend indicates the amount of information  provided by each pair of plants: a pair of generalists which share most of their interaction partners gives a stronger indication of phylogenetic signal than a pair of \DIFdelbegin \DIFdel{extreme }\DIFdelend specialists with one common interaction partner.
	...
	\DIFdelbegin \DIFdel{Together, $M_{ij}$ and $U_{ij}$ give a Jaccard index ($J_{ij}$) describing 
			...
			%DIFAUXCMD
\DIFdel{where $M_{ij}$ is the set of }\emph{\DIFdel{mutual}} %DIFAUXCMD
\DIFdel{(shared) interaction partners and $U_{ij}$ the set of unshared interaction partners for plants $i$ and $j$.
}%DIFDELCMD < 
...
2. Request to state that we use the Jaccard index more explicitly \DIFaddbegin [[\DIFadd{done}]]
\DIFaddend 
...
5. Suggestion to consider phylogenetic diversity instead of number of plant pairs \DIFaddbegin [[\DIFadd{done}]]
\DIFaddend 
	...
	\begin{refquote}
		* Testing the effect of network size on the existence of a phylogenetic signal
		\DIFdelbegin %DIFDELCMD < \\
%DIFDELCMD < 			%%%
\DIFdelend Here, it is specifically the number of plant pairs that is studied. I wonder whether the phylogenetic diversity of plants would not be more adapted here. Is it overlooked because similar among networks?
...
\DIFdelbegin \DIFdel{We have also added a few lines to the methods to formally introduce the problem of multiple testing, some of the objections to the strict Bonferroni in~\mbox{%DIFAUXCMD
\citet{Moran2003}}\hspace{0pt}%DIFAUXCMD
...
(}\emph{\DIFdel{Supplemental Information 4}}%DIFAUXCMD
\DIFdel{).
}%DIFDELCMD < 
...
7. Suggestion to mention sampling completeness as a potential explanation for specialists \DIFaddbegin [[\DIFadd{done}]]
\DIFaddend 
...
\DIFdelend 
	...
	Lines \DIFdelbegin \DIFdel{386-391}\DIFdelend \DIFaddbegin \DIFadd{XX-XX}\DIFaddend :

	\begin{quotation}

		\DIFdelbegin \DIFdel{Note that }\DIFdelend \DIFaddbegin \DIFadd{It is also likely that at least }\DIFaddend some of the apparent specialists in our dataset \DIFdelbegin \DIFdel{may actually be rare species involved in more interactions which }\DIFdelend \DIFaddbegin \DIFadd{are actually rare species for which many interactions }\DIFaddend have not yet been observed~\citep{Bluthgen2006,Poisot2015}. Without information on the sampling completeness of the networks in our dataset, it is difficult to estimate the size of this effect. \DIFdelbegin \DIFdel{It is possible, however, that we might observe stronger relationships between phylogenetic distance and niche overlap with }\DIFdelend \DIFaddbegin \DIFadd{In any case, the degree of phylogenetic conservation of interaction partners may change as we obtain }\DIFaddend more complete data on rare species.
...
\DIFdel{showed different trends in different network types. 
			...
			Multiple types of interactions (}\DIFdelend \DIFaddbegin \DIFadd{- merging interaction types is a good way to bring back to broader context :) - line 439-442 could be clarified based on Strauss \& Whitthall (if I can find it) - more references for structure of interaction patterns: }\DIFaddend e.g., \DIFdelbegin \DIFdel{pollination, herbivory, nectar robbing) 
			and even environmental factors can influence traits such as 
			flower colour, nectar abundance, and flowering phenology~\mbox{%DIFAUXCMD
\citep{Strauss2006}}\hspace{0pt}%DIFAUXCMD
. These influences can act in the same or different directions~\mbox{%DIFAUXCMD
...
. The interplay between these different selective pressures may mean that plants
			...
			with many pollinators }\emph{\DIFdel{or}} %DIFAUXCMD
\DIFdel{many herbivores but not both~\mbox{%DIFAUXCMD
...
\citep{Astegiano2017}}\hspace{0pt}%DIFAUXCMD
. The nature of the effects of multiple interaction types on both phylogenetic signal in interactions and overall network structure is, however, still an open question deserving of much more research.}\DIFdelend \DIFaddbegin \DIFadd{Astegiano et al. - be more tentative for dynamical drivers (apparently Sauve et al. don't really discuss stability). Could be a by-product of assembly process (Maynard et al., 2018)
}\DIFaddend 
...
%DIFDELCMD < 			%%%
\DIFdelend We calculated niche overlap for each pair of plants $i$ and $j$ \DIFdelbegin \DIFdel{based on }\DIFdelend \DIFaddbegin \DIFadd{by 
	    combining }\DIFaddend the number of shared \DIFdelbegin \DIFdel{and unshared }\DIFdelend interaction
	    partners ($M_{ij}$\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{) and the number of interaction partners which are not
	    shared (}\DIFaddend $U_{ij}$\DIFdelbegin \DIFdel{, respectively) . 
			The number of unshared interaction partners gives valuable information about cases where, for example, 
			closely-related plants may have experienced disruptive selection, leading to weaker phylogenetic signal. The sum $M_{ij} + U_{ij}$ indicates }\DIFdelend \DIFaddbegin \DIFadd{) into a Jaccard index ($J_{ij}$) describing 
	    the proportion of shared interactions. Importantly, we do this while 
	    preserving }\DIFaddend the amount of information provided by each pair of plants
	    \DIFdelbegin \DIFdel{: a pair of generalists which share most of their interaction partners gives a stronger indication of phylogenetic signal than a pair of extreme specialists with one common interaction partner.
}%DIFDELCMD < 

%DIFDELCMD < 			%%%
\DIFdel{Together, $M_{ij}$ and $U_{ij}$ give a Jaccard index ($J_{ij}$)describing 
			the proportion of shared interactions}\DIFdelend \DIFaddbegin \DIFadd{(indicated by their numbers of interaction partners)}\DIFaddend . $J_{ij}$ is \DIFdelbegin \DIFdel{defined: 
			}\DIFdelend \DIFaddbegin \DIFadd{usually defined as: 
	    %DIF > 
	    }\DIFaddend \begin{equation}
	      J_{ij} = \DIFdelbegin \DIFdel{\frac{M_{ij}}{U_{ij}+M_{ij}} }\DIFdelend \DIFaddbegin \DIFadd{\frac{M_{ij}}{P_i+P_j-M_{ij}} }\DIFaddend ,
	    \end{equation}
	    %DIF > 
	    where $M_{ij}$ is the set of \emph{mutual} (shared) interaction partners \DIFaddbegin \DIFadd{of 
	    species $i$ and $j$ }\DIFaddend and \DIFdelbegin \DIFdel{$U_{ij}$ the set of unshared interaction 
	    partners for plants }\DIFdelend \DIFaddbegin \DIFadd{$P_i$ and $P_j$ are the sizes of the sets of interaction 
	    }\emph{\DIFadd{partners}} \DIFadd{for species }\DIFaddend $i$ and $j$ \DIFdelbegin \DIFdel{.
			In our statistical analyses (see below), we }\DIFdelend \DIFaddbegin \DIFadd{respectively. $J_{ij}$ can also be defined:
	    %DIF > 
	    }\begin{equation}
	      \DIFadd{J_{ij} = \frac{M_{ij}}{U_{ij}+M_{ij}} ,
	    }\end{equation}
	    %DIF > 
	    \DIFadd{since $U_{ij}$ = $P_{i}$+$P_{j}$-2$M_{ij}$. This second definition more closely
	    relates to our methodology, which }\DIFaddend used the tuple ($M_{ij}$, $U_{ij}$) as the
	    dependent variable rather than the single value $J_{ij}$. \DIFdelbegin \DIFdel{This }\DIFdelend \DIFaddbegin \DIFadd{Using this tuple form
	    }\DIFaddend allows us to \DIFdelbegin \DIFdel{preserve information about the amount of information provided by each pair of plants and weight the observations accordingly}\DIFdelend \DIFaddbegin \DIFadd{give more 
	    weight to species sharing a large number of interaction partners as well as 
	    those sharing a large proportion (i.e., to emphasise pairs of generalists 
	    sharing most of their interaction partners over specialists sharing a single 
	    interaction partner)}\DIFaddend . Note that species sharing a large \emph{number} of interaction partners may not share a large \emph{proportion} of interaction partners if the number of interaction partners that are not shared is also large. \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < 		    %%%
\DIFdelend %DIF >  Added because Josh got confused about the distinction.
	    \end{quotation}


14. Rephrasing of permutation strategy confusing \DIFaddbegin [[\DIFadd{done}]]
	\DIFaddend 
...
15. Typo in page 15, lines 322-324 \DIFaddbegin [[\DIFadd{done}]]
\DIFaddend 
	...
	Lines \DIFdelbegin \DIFdel{350-352:
	}%DIFDELCMD < 

%DIFDELCMD < 		%%%
\DIFdelend \DIFaddbegin \DIFadd{XX-XX:
	}\DIFaddend \begin{quotation}
		\DIFdelbegin \DIFdel{Plants }\DIFdelend \DIFaddbegin \DIFadd{More closely-related plants }\DIFaddend in pollination networks did, however, \DIFdelbegin \DIFdel{have a lower intercept probability of sharing }\DIFdelend \DIFaddbegin \DIFadd{tend to share fewer }\DIFaddend interaction partners ($\beta_{pollination}$=-0.776, $p$=0.007), similar to our within-network results above.
	\end{quotation}


16. Fig. 3, Table 2 conflict for Poaceae \DIFaddbegin [[\DIFadd{done}]]
\DIFaddend 
...
%DIF <  Check. % Astegiano, J., Altermatt, F. and Massol, F., 2017. Disentangling the co-structure of multilayer interaction networks: degree distribution and module composition in two-layer bipartite networks. Scientific reports, 7(1), p.15465.
%DIF >  Astegiano, J., Altermatt, F. and Massol, F., 2017. Disentangling the co-structure of multilayer interaction networks: degree distribution and module composition in two-layer bipartite networks. Scientific reports, 7(1), p.15465.

%DIF <  Check. % Maynard, D.S., Serván, C.A. and Allesina, S., 2018. Network spandrels reflect ecological assembly. Ecology letters, 21(3), pp.324-334.
%DIF >  Maynard, D.S., Serván, C.A. and Allesina, S., 2018. Network spandrels reflect ecological assembly. Ecology letters, 21(3), pp.324-334.

%DIF <  Check. % Melián, C.J., Bascompte, J., Jordano, P. and Krivan, V., 2009. Diversity in a complex ecological network with two interaction types. Oikos, 118(1), pp.122-130.
%DIF >  Melián, C.J., Bascompte, J., Jordano, P. and Krivan, V., 2009. Diversity in a complex ecological network with two interaction types. Oikos, 118(1), pp.122-130.

%DIF <  Check. % Moran, M.D., 2003. Arguments for rejecting the sequential Bonferroni in ecological studies. Oikos, 100(2), pp.403-405.
%DIF >  Moran, M.D., 2003. Arguments for rejecting the sequential Bonferroni in ecological studies. Oikos, 100(2), pp.403-405.

%DIF <  Check. % Strauss, S.Y. and Whittall, J.B., 2006. Non-pollinator agents of selection on floral traits. Ecology and evolution of flowers, pp.120-138.
%DIF >  Strauss, S.Y. and Whittall, J.B., 2006. Non-pollinator agents of selection on floral traits. Ecology and evolution of flowers, pp.120-138.

  \newpage


\DIFdelbegin %DIFDELCMD < \bibliographystyle{newphy} 
%DIFDELCMD < \renewcommand*{\bibfont}{\raggedright}
%DIFDELCMD < \bibliography{manual}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \bibliographystyle{prsb} 
