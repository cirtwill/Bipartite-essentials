...
%
  ...
  % [[Is this cogent? Correct? If not, I think I will have to remove all reference to type II error and hope we don't get the same reviewer again. It may not be an issue since we've moved away from the motif-like measures.]]
  % DBS: I think it's fine.
...
\section*{Results}
  ...
  % Regression of all families at once with RE's for network
    ...
    For the 47 families % DBS: Alyssa, please check this number!
    ...
    % DBS: The section above seems like it would fit better in the Methods and then we just say nothing about these families.
