...
\section*{Figures}
  ...
  \begin{figure}[!h]
    ...
    \end{center}
     ...
     dark lines). There was substantial variation among networks (thin, pale lines) of both types.}
