...
% Main text: 6719 % Limit 6,500
% Try to cut methods ... maybe then discussion.

% \begin{itemize}
%   \item Introduction: 1165 
%   \item Materials and Methods: 2619 
%   \item Results: 960
%   \item Discussion: 1892
...
\section*{Materials and Methods}
  ...
  \subsection*{Calculating niche overlap within communities}
    ...
    those sharing a large proportion. Note that species sharing a large \emph{number} of interaction partners may not share a large \emph{proportion} of interaction partners if the number of interaction partners that are not shared is also large. % Added because Josh got confused about the distinction.
