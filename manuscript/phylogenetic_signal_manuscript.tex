...
\section*{Results}
  ...
  % Regression of all families at once with RE's for network
    ...
    For the 48 families that were well represented in pollination networks, overlap decreased
    ...
    % DBS: According to the table, this should probably be Apiaceae and Poaceae. Please check.
