...
% Main text: 6498 % Limit 6,500 % Can also subtract 25 for page numbers

% \begin{itemize}
%   \item Introduction: 1165 
%   \item Materials and Methods: 2470
%   \item Results: 960
%   \item Discussion: 1820
...
\section*{Materials and Methods} 
  ...
  \subsection*{Calculating niche overlap}
    ...
    Note that species sharing a large \emph{number} of interaction partners may not share a large \emph{proportion} of interaction partners if the number of interaction partners that are not shared is also large. % Added because Josh got confused about the distinction.
  ...
  \subsection*{Testing conservation of niche overlap within networks} 
    ...
    $j$ and $J_{ij}$ is defined by the tuple ($M_{ij}$, $U_{ij}$) (see \emph{Supplemental Information 2} for R implementation). 
...
\section*{Results}
  ...
  \subsection*{Within-network conservation of niche overlap} 
    ...
    permuted networks, there was no relationship, which speaks to the robustness of our methodology (\emph{Supporting information 4}). 
  ...
  % Regression of all families at once with RE's for network
    ...
    a further 34 plant families (see \emph{Supporting information 5} for further 
