...
\noindent Supporting information: 1 file containing 6 sections.
...
\section*{Materials and Methods} 
  ...
  \subsection*{Testing conservation of niche overlap within networks} 
    ...
    $j$ and $J_{ij}$ is defined by the tuple ($M_{ij}$, $U_{ij}$) (see \emph{Supporting information 2} for R implementation). 
    ...
    \subsubsection*{Accounting for non-independence}
      ...
      alternative hypothesis was set farther from zero (\emph{Supporting information 5}).
...
\section*{Results}
  ...
  \subsection*{Within-network conservation of niche overlap} 
    ...
    permuted networks, there was no relationship, which speaks to the robustness of our methodology (\emph{Supporting information 5}). 
  ...
  % Regression of all families at once with RE's for network
    ...
    a further 34 plant families (see \emph{Supporting information 6} for further 
